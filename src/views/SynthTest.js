    ...
    <>
      <div className="body ">
        <div className="d-flex align-items-center control-group">
          <label
            htmlFor="help"
            className="ms-5 me-3 mt-1 control control-checkbox"
          >
            Info View
            <input
              type="checkbox"
        ...
        <p className="tool text-center">
          {checked ? (
            <>
              <p className="tooltips d-inline-flex">
                Use corresponding keys to play
              </p>
            </>
          ) : (
            <></>
        ...
        <div className="d-flex justify-content-center align-items-center">
          ...
          >
            <span className="tool">
              {checked ? (
                <>
                  <p className="tooltips">Down one octave</p>
                </>
              ) : (
                <></>
              )}
            </span>
            <BsArrowLeftCircle size={30} className="me-2 mt-5 octave-arrow" />{" "}
          </button>
          ...
          >
            <span className="tool2">
              {checked ? (
                <>
                  <p className="tooltips">Up one octave</p>
                </>
              ) : (
                <></>
              )}
            </span>
            <BsArrowRightCircle size={30} className="ms-2 mt-5 octave-arrow" />
          </button>
        </div>
        <Effects synth={synth} />
        <span className="tool effect-tool ms-5">
          {checked ? (
            <>
              <p className="tooltips d-inline-flex">Enable/disable effects</p>
            </>
          ) : (
            <></>
          )}
        </span>
        <span className="tool effect-tool2 ms-3">
          {checked ? (
            <>
              <p className="tooltips d-inline-flex ">
                Adjust effects with slider
              </p>
            </>
          ) : (
            <></>
        ...
        {user.username ? (
          <>
            ...
            <span className="tool record-tool">
              {checked ? (
                <>
                  <p className="tooltips d-inline-flex">Record audio</p>
                </>
              ) : (
                <></>
              )}
            </span>
            <span className="tool record-tool2">
              {checked ? (
                <>
                  <p className="tooltips d-inline-flex ">
