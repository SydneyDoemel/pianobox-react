                        ...
                        <div className="card m-3" key={i}>
                          <div className="card-body">
                            ...
                            <div className="card-btns">
                              ...
                              <button
                                onClick={() => {
                                  deleteAudio(url[1]._location.path_);
                                  setToggle(!toggle);
                                }}
                              ...
                              <button
                                type="button"
                                onClick={() => setInput(url[1]._location.path_)}
                              ...
                              <button
                                onClick={() => handleSaveToFolder(url)}
                                className="btn btn-outline-dark mr-5 profile-btn"
                              >
                                Add note
                              </button>
                                ...
                                <div className="modal-dialog" role="document">
                                  <div className="modal-content">
                                    ...
                                    <div className="modal-body">
                                      <form
                                        onSubmit={(e) => handleSaveToFolder(e)}
                                      >
                                        <input
