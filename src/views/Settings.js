        ...
        <div className="card mx-auto">
          ...
          <div className="d-flex flex-column text-center settings-buttons card-body">
            <div className="">
              <button
                type="button"
                className="btn btn-outline-dark btn-purp my-3 settings-btn"
                ...
                <div className="modal-dialog">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      ...
                      >
                        <label htmlFor="newusername" className="me-4">
                          New Username
                        </label>
                        <input
                          type="text"
                ...
                <div className="modal-dialog">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      ...
                      >
                        <label className="me-4" htmlFor="newemail">
                          New Email
                        </label>
            ...
            <div>
                  ...
                  <div className="modal-dialog">
                    <div className="modal-content">
                      ...
                      <div className="modal-body">
                        ...
                        >
                          <label className="me-4" htmlFor="newpass">
                            New Password
                          </label>
                          <input type="password" id="newpass" name="newpass" />
                          <br />
                          <br />
                          <label className="me-4" htmlFor="confirmpass">
                            Confirm Password
                          </label>
                          <input
                            type="password"
              ...
              <div>
                <button
                  type="button"
                  className="btn btn-danger my-3 settings-btn"
                  data-bs-toggle="modal"
